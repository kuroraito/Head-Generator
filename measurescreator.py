...
body_height_Z_parts = sorted([
    "head_height_Z", "neck_height_Z"])

measures_parts_points = sorted([
    "head_height_Z", "head_width_X", "neck_height_Z", "head_length"])
    
measures_parts_girths = sorted([
    "neck_girth"])

score_weights = sorted([
    "head_height_Z", "head_width_X",
    "chest_depth_Y", "neck_girth",
    "head_length", "chest_girth", "neck_height_Z"])
